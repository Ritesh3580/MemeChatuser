...
import {AppNavigation, navigationRef, pushToScreen} from '../../Source/Navigations/StackNavigation'
...
const config = {
   ...
   serverUrl: "https://videocallpriyanka.herokuapp.com"
}
///\/\/\/\/\/\/\/\/\/\/\/\/\ 🔔🔔🔔 READ THIS IF YOU WANT TO DO MORE 🔔🔔🔔 /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
...
class AppJsVideocalling extends Component {
   routesInstance;
   navigationRef;
   messageListener;
...
export default AppJsVideocalling