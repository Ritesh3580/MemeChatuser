...
export default function FollwersScreen(props) {
    ...
    async function userProfile() {
        ...
        axios.get(user_URL, { headers: { Authorization: `Bearer ${token}` } }).then(resp => {
            setUserData(resp.data);
            setData(resp.data.followers);
            setLoading(false);
        })
            .catch(err => {
    ...
    const submit_Follow = async (host) => {
        ...
        axios({
            ...
            console.log("submit follow--->>>", err.response.data);
            SimpleToast.show("Something error occured!");
        })
    };
                        ...
                        <FlatList
                            ...
                            renderItem={({ item, index }) => (
                                ...
                                >
                                    ...
                                    {
                                        userData?.followings.includes(item._id) ?
                                            <TouchableOpacity
