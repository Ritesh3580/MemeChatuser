    ...
    isMe ?
        {
            ...
            bgc: { backgroundColor: Colors.gray },
        ...
        return (
            <View style={{ paddingVertical: 5 }}>
                <View style={{
                    ...
                    <Text style={{ color: item.direction == 0 ? Colors.white : Colors.gray, fontSize: 10, paddingRight: 5 }}>
                        {moment(Number(item.timestamp)).format('LT')}
                    </Text>
                </View>
                <Text style={[styles.date_time_sender,{color: item.direction == 0 ? Colors.white : Colors.gray}]}>
